...
namespace App.Domain.Core.Admin.Data
{
    ...
    {
        public Task<Entities.Admin> CreateAdmin(Entities.Admin signingUpAdmin, CancellationToken cancellationToken);
        ...
        public Task<Admin.DTOs.AdminDto> UpdateAdmin(Entities.Admin updatingAdmin, CancellationToken cancellationToken);
