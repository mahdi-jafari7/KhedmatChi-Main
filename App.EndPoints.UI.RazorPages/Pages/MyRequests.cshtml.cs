...
namespace App.EndPoints.UI.RazorPages.Pages
{
    ...
    public class MyRequestsModel : PageModel
    {
        ...
        public async Task OnGet(CancellationToken cancellationToken)
        {
            ...
            {
                request.ProposalsCount = await _serviceRequestAppService.GetServiceRequestProposalsCount(request.Id, cancellationToken);
            }
        }
		...
		//public async Task<IActionResult> OnPostUpdate(int requestId, CancellationToken cancellationToken)
		//{
		//	var request = await _serviceRequestAppService.GetServiceRequestById(requestId,cancellationToken);
		//	return _serviceRequestAppService.UpdateServiceRequest(request, cancellationToken);
		//}
    }
}
