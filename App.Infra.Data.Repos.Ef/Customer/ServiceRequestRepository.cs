    ...
    public class ServiceRequestRepository : IServiceRequestRepository
    {
        ...
        public async Task<ServiceRequestDto> GetServiceRequestById(int serviceRequestId, CancellationToken cancellationToken)
        {
                ...
                else
                {
                    ...
                    throw new Exception("خطا! دوباره تست کنید");
                }
        }
        ...
        public async Task<int> GetServiceRequestProposalsCount(int serviceId, CancellationToken cancellationToken)
        {
            var count = await _homeServiceDbContext.Proposals
                .Where(x => x.ServiceRequestId == serviceId).CountAsync();
